...
const PitchGenerator = () => {
    ...
    const generatePitch = async () => {
        if (!idea.trim()) {
            setToast({ message: 'Please enter your project idea first', type: 'error' });
            return;
        }
        ...
        <div className="min-h-screen bg-black py-12">
            ...
            <div className="max-w-4xl mx-auto px-6">
                <div className="border-2 border-[#FFD700]/20 rounded-xl p-6 hover:border-[#FFD700]/40 transition-all duration-300">
                    ...
                    <div className="mb-6">
                        <label className="block text-[#FFD700] text-lg font-medium mb-2">Your Project Idea*</label>
                        <textarea
                            value={idea}
                            onChange={(e) => setIdea(e.target.value)}
                            placeholder="Paste your project idea here..."
                            className="w-full h-40 p-3 bg-black border-2 border-[#FFD700]/40 rounded-lg text-white placeholder-[#FFD700]/50 focus:border-[#FFD700] focus:ring-1 focus:ring-[#FFD700] hover:border-[#FFD700]/60 transition-all duration-300"
                        />
                    </div>
