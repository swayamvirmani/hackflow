...
`;
    ...
    const handleSavePitch = () => {
        try {
            ...
            saveIdea(user.uid, idea, pitch); // Pass uid correctly
            setIsSaved(true);
                ...
                <div className="border-2 border-[#01FF00]/20 rounded-xl p-6 hover:border-[#01FF00]/40 transition-all duration-300">
                    ...
                    <div className="mb-6">
                        ...
                        <textarea
                            ...
                            className="w-full h-40 p-3 bg-black border-2 border-[#01FF00]/40 rounded-lg text-white placeholder-[#01FF00]/50 focus:border-[#01FF00] focus:ring-1 focus:ring-[#01FF00] hover:border-[#01FF00]/60 transition-all duration-300"
                        />
                    </div>
